"""Constantes globales del módulo GeoMIP.
...
Typical usage example::
    ...
    from src.constants.base import FLOAT_ZERO, COLS_IDX, RUTA_SAMPLES

    acumulador: float = FLOAT_ZERO
    columna_efecto: int = COLS_IDX
    ruta = RUTA_SAMPLES + "mi_red.csv"
"""

from __future__ import annotations

import numpy as np  # noqa: F401 — reservado para extensiones numéricas
...
LAST_IDX: int = -INT_ONE   # Índice del último elemento (acceso negativo)

# ROWS_IDX / ACTUAL → dimensión 0 (filas / estado actual)
# COLS_IDX / EFECTO  → dimensión 1 (columnas / estado efecto)
...
# ---------------------------------------------------------------------------
BITS: tuple[int, int] = (0, 1)          # Valores posibles de un bit
ACTIVOS, INACTIVOS = True, False         # Alias booleanos de estado
...
# ---------------------------------------------------------------------------
LOGS_PATH: str = ".logs"                # Directorio raíz de logs
SAMPLES_PATH: str = "src/.samples/"    # Muestras de redes de prueba
PROFILING_PATH: str = "review/profiling"  # Salida de perfiles pyinstrument
RESOLVER_PATH: str = "review/resolver"   # Salida de resultados del resolver
