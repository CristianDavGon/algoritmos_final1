"""Enumeración de notaciones de indexado binario para la estrategia QNodes.
...
class Notation(Enum):
    """Notaciones de indexado binario admitidas por la estrategia QNodes.

    Cada miembro expone un identificador de cadena a través de ``.value``
    que es el valor almacenado en
    :attr:`~src.models.base.application.Application.notacion_indexado`.
