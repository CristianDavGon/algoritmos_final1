"""Generadores de particiones y subsistemas para la estrategia de fuerza bruta.
...
Estas rutinas constituyen el motor combinatorio que alimenta la
estrategia de búsqueda exhaustiva de la MIP (partición de integración
mínima) en QNodes.
