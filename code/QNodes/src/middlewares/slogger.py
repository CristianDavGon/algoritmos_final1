"""Middleware de logging estructurado para QNodes.
...
A diferencia de la versión GeoMIP, esta implementación limpia los
handlers existentes antes de registrar nuevos, garantizando que no
se acumulen duplicados en ejecuciones sucesivas dentro del mismo proceso.
...
class SafeLogger:
    ...
    ``<PATH_LOGS>/DD_MM_YYYY/HHhrs/<name>.log`` y un archivo
    ``last_<name>.log`` en el directorio raíz para acceso rápido al
    último log.

    A diferencia de la versión GeoMIP, cierra y elimina los handlers
    anteriores antes de crear nuevos para evitar duplicación de mensajes
    en ejecuciones repetidas dentro del mismo proceso Python.
    ...
    def __setup_logger(self, name: str) -> logging.Logger:
        ...
        Cierra y elimina los handlers existentes antes de crear nuevos
        para evitar duplicación de mensajes en ejecuciones repetidas.
        ...
        # Cierra y limpia handlers existentes para evitar duplicados
