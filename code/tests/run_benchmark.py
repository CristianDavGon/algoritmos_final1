...
def run_qnodes(estado: str, pagina: str, n_tests: int | None) -> None:
...
def run_geomip(estado: str, pagina: str, n_tests: int | None) -> None:
...
def main() -> None:
    ...
    if args.algo == "qnodes":
        run_qnodes(args.estado, args.pagina, args.n_tests)
    else:
        run_geomip(args.estado, args.pagina, args.n_tests)
